 ...
 *     description: Logged in notifications can fetch only their own notification information. Only admins can fetch other notifications.
 *     tags: [Notifications]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in notifications can only update their own information. Only admins can update other notifications.
 *     tags: [Notifications]
 *     security:
 *       - bearerAuth: []
 *     parameters:
