 ...
 *     description: Logged in messages can fetch only their own message information. Only admins can fetch other messages.
 *     tags: [Messages]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in messages can only update their own information. Only admins can update other messages.
 *     tags: [Messages]
 *     security:
 *       - bearerAuth: []
 *     parameters:
